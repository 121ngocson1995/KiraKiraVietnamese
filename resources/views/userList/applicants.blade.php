@if (isset($users))
<div id="load" class="applicants" style="position: relative;">
	<table class="table table-hover" id="studentTable">
		...
		<tr>
			...
			<td>
				<a href="{{ $user->cv && strcmp($user->cv, '') != 0 ? \Storage::url($user->cv) : '#' }}" class="btn btn-warning btn-sm" {{ $user->cv && strcmp($user->cv, '') != 0 ? 'download' : 'disabled' }}><i class="fa fa-download"></i>Download CV</a>
